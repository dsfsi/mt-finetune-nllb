...
Prepare your translation data in one of the supported formats (JSON, JSONL, CSV, TSV). Ensure the data contains source and target text columns.

> **NB:** We provide a script to filter translation datasets based on length, ratio, and semantic alignment criteria. See [FILTER.md](FILTER.md) for details on how to use it.
